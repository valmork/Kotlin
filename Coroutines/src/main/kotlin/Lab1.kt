...
class ProductionSortFrame : JFrame("Production Rules Sort") {
    ...
    init {
        ...
        rulesModel.addElement(ProductionRule("swap_ba", "ba", "ab"))
        rulesModel.addElement(ProductionRule("swap_ca", "ca", "ac"))
        rulesModel.addElement(ProductionRule("swap_cb", "cb", "bc"))
